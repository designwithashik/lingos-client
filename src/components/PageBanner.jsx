...
const PageBanner = () => {
    return (
            ...
            <section className="flex font-bold text--500 bg-cover bg-center z-30 justify-center items-center mb-11 gap-5 py-11 " style={{
            ...
            <p className="text-4xl w-full  mx-auto  border-x-4 p-6 my-5">Classes</p>
